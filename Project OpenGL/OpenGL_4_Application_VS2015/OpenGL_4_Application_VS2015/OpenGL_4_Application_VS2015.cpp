...
#define END_OF_RACE -120
#define START_POSITION_1 glm::vec3(4.0f, 2.15f, 120.0f)
#define START_POSITION_2 glm::vec3(-10.0f, 2.15f, 120.0f)
...
int glWindowWidth = 640, glWindowHeight = 480, retina_width, retina_height, car_position_start = 0, car_position_final = 0;
double lastX = glWindowWidth / 2, lastY = glWindowHeight / 2, car_1_displacement = 120.0f, car_2_displacement = 120.0f;
bool firstMouse = true, pressedKeys[1024], start_race = false;
float yaw = -90.0f, pitch = 0.0f, lightAngle, cameraSpeed = 0.01f, angle = 0.0f;
GLFWwindow* glWindow = NULL;
glm::vec3 lightDir, lightColor, car_1_final_pos = START_POSITION_1, car_2_final_pos = START_POSITION_2;
